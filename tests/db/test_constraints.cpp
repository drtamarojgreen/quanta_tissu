...
TEST_CASE(CollectionUniqueConstraint) {
    ...
    doc1.id = "user1";
    TissDB::Element elem1; elem1.key = "email"; elem1.value = std::string("alice@example.com");
    ...
    doc2.id = "user2";
    TissDB::Element elem2; elem2.key = "email"; elem2.value = std::string("alice@example.com");
    ...
    doc3.id = "user3";
    TissDB::Element elem3; elem3.key = "email"; elem3.value = std::string("bob@example.com");
