...
public:
    ...
    void create_index(const std::vector<std::string>& field_names, IndexType type = IndexType::STRING, bool is_unique = false);
...
private:
    ...
    std::map<std::string, BTreeVariant> indexes_;
