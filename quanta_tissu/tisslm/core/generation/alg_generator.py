...
class AlgorithmicGenerator:
    ...
    def sample(self, prompt_tokens, n_new_tokens, method="greedy", temperature=1.0, top_k=None, top_p=None, repetition_penalty=1.0, eos_id=None, bias_token_id=None, bias_strength=0.0, query_embedding=None, hessian_matrix=None):
        """
