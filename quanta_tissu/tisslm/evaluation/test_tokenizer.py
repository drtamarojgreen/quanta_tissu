...
def main():
    ...
    tokenizer_relative_path = "models/tokenizers/revised_tokenizer"

    tokenizer_full_path = os.path.join(project_root, tokenizer_relative_path)
    ...
    try:
        ...
        print(f"Error: Tokenizer files not found at {tokenizer_full_path}. {e}", file=sys.stderr)
